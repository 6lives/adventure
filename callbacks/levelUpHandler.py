...
from callbacks.levelUpModel import LevelUpCallback, Attribute
...
async def level_up_handler(callback: CallbackQuery, callback_data: LevelUpCallback, players: dict):
    ...
    await callback.bot.edit_message_reply_markup(callback.message.chat.id, callback.message.message_id,
                                                 reply_markup=None)
